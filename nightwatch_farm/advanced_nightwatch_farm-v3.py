...
class NightwatchFarmApp:
    ...
    def _render_flat_meadow_and_farm(self):
        ...
        self.screen.blit(FONT_SM.render("🌾 中央：高架農田與金庫（空田過夜將被掠奪金庫！保護作物獲月光加成+50%）", True, (93, 64, 55)), (farm_rx + 8, farm_ry - 20))
        self.screen.blit(FONT_SM.render("🌸 四周：莊園景觀區（佈置果樹・噴泉・蜜蜂塔・永久繁榮度）", True, (56, 142, 60)), (GRID_X + 8, GRID_Y - 20))
